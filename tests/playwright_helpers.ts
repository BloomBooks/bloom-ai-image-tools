...
export const writeImageDataToClipboard = async (page: Page, imageData: string) => {
...
export const readClipboardImage = async (page: Page) => {
...
export const setOpenRouterApiKey = async (page: Page, key: string) => {
  ...
  const input = page.getByTestId("openrouter-api-key-input").locator("input").first();

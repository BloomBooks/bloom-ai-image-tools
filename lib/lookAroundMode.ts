/**
 * The one sentence a look-around session is told, wherever it is told: the opening
 * notice (PlaygroundNoticeDialog) and the place an OpenRouter connection would

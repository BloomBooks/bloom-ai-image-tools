...
export const ImageSlotActions = React.forwardRef<ImageSlotActionsHandle, ImageSlotActionsProps>(
  function ImageSlotActions(props, ref) {
    ...
    React.useImperativeHandle(
      ...
      [variant, isHovered, isDndDragging, isThumbOverflowOpen, isThumbMoreReady, scheduleMoreReady],
    );
    ...
    const coreActionsRaw = [
      {
        ...
        testId: "image-slot-action-upload",
      },
      {
        key: "paste",
        icon: Icons.Paste,
        ...
        testId: "image-slot-action-paste",
      },
      {
        key: "copy",
        icon: Icons.Copy,
      ...
      },
      {
        ...
        testId: "image-slot-action-download",
      },
      {
        key: "remove",
        icon: Icons.X,
        ...
        testId: "image-slot-action-remove",
      },
